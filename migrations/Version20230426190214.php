 ...
 */
final class Version20230426190214 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item ADD CONSTRAINT FK_1F1B251E5080ECDE FOREIGN KEY (warehouse_id) REFERENCES warehouse (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
